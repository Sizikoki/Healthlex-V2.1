...
export const HOME_CONTENT = {
  tr: {
    ...
    pricing: {
      ...
      features: (totalMorphemes) => [
        { active: true, text: `14 kategorinin tamamı + ${totalMorphemes}'den fazla morfem kütüphanesi` },
  ...
  en: {
    ...
    pricing: {
      ...
      features: (totalMorphemes) => [
        { active: true, text: `All 14 categories + over ${totalMorphemes} morpheme library` },
