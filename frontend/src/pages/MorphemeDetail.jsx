    ...
    <div className="min-h-screen bg-background py-10 px-4 sm:px-6 lg:px-8">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{
        __html: JSON.stringify({
          ...
          "inDefinedTermSet": "https://www.healthlexmed.com/morphemes"
        }).replace(/</g, '\\u003c')
      }} />
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="p-8 rounded-2xl gradient-hero border border-primary/20 shadow-md text-center space-y-4">
          ...
          <p className="text-sm text-muted-foreground max-w-xl mx-auto leading-relaxed">
            {isTr
              ? '570+ morfem ve 16 kategori ile anatomiyi 4 interaktif oyun modunda test edin. Flashcard, Eşleştirme, Quiz ve Morfem Çözümleme ile bilginizi kalıcı hale getirin.'
              : 'Master Latin medical terminology through 570+ morphemes, 16 categories and 4 game modes. Flashcards, Matching, Quiz, and Morpheme Breakdown.'}
          </p>
