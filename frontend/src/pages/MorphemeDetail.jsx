      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="p-8 rounded-2xl gradient-hero border border-primary/20 shadow-md text-center space-y-4">
          ...
          <p className="text-sm text-muted-foreground max-w-xl mx-auto leading-relaxed">
            {isTr
              ? '570+ morfem ve 15 kategori ile anatomiyi 4 interaktif oyun modunda test edin. Flashcard, Eşleştirme, Quiz ve Morfem Çözümleme ile bilginizi kalıcı hale getirin.'
              : 'Master Latin medical terminology through 570+ morphemes, 15 categories and 4 game modes. Flashcards, Matching, Quiz, and Morpheme Breakdown.'}
          </p>
