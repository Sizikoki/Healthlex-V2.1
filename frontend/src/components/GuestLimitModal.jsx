      ...
      <DialogContent className="sm:max-w-md bg-white border-2 border-primary/20 shadow-2xl p-6 rounded-2xl">
        <DialogHeader className="text-center sm:text-center items-center">
          ...
          <DialogDescription className="text-base text-gray-600 mt-2 leading-relaxed">
            Misafir kullanıcılar için günlük <strong className="text-amber-600">3 ücretsiz oyun</strong> oynama hakkı mevcuttur. Bugünkü tüm haklarınızı kullandınız.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 my-3 text-sm text-amber-900 flex items-start gap-3">
          ...
          <div>
            <strong className="font-semibold block text-amber-950">Ücretsiz Üye Olun & Sınırsız Oynayın!</strong>
            Kayıt olarak sınırsız oyun oynayabilir, ilerlemenizi tüm cihazlarınızda senkronize edebilirsiniz.
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2.5 mt-2">
          ...
          >
            ...
            Ücretsiz Üye Ol (Sınırsız Erişim)
          </Button>
