...
const TRANSLATIONS = {
  tr: {
    ...
    proLockCategories: '15 kategoride ilerleme takibi Temel plan ve üzeri planlarda açılır.',
  ...
  en: {
    ...
    proLockCategories: 'Progress tracking across 15 categories unlocks with Basic plan and above.',
