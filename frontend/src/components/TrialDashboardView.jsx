...
const TRANSLATIONS = {
  tr: {
    ...
    proLockCategories: '14 kategoride ilerleme takibi Temel plan ve üzeri planlarda açılır.',
  ...
  en: {
    ...
    proLockCategories: 'Progress tracking across 14 categories unlocks with Basic plan and above.',
